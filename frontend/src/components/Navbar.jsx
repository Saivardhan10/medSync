...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-[#ADADAD]'>
      <img onClick={() => navigate('/')} className='w-36 cursor-pointer rounded-xl' src={assets.logo} alt="" />
      <ul className='md:flex items-start gap-5 font-medium hidden'>
        ...
        <NavLink target='_blank' to='https://ai-based-doctor-recommendation-system.streamlit.app/' >
          <li className='bg-[#39FF14] text-white border px-5 text-xs py-1.5 rounded-full border-black'>MedSync.AI</li>
        </NavLink>
      </ul>
